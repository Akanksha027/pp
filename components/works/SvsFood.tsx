  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 py-20 border-t border-white/10">
         <h2 className="text-3xl font-light mb-12">Live Kiosk Preview</h2>
         <div className="flex justify-center">
            <div className="bg-white/5 rounded-3xl p-6 sm:p-8 border border-white/10 flex flex-col items-center justify-center max-w-lg w-full">
               <h3 className="text-xl font-medium mb-6 text-white/80">Dashboard Console</h3>
      ...
      <div className="pt-10">
         ...
         <div className="space-y-24 mt-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
               ...
               <div className="relative aspect-[9/19] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 w-full max-w-[320px] justify-self-center lg:justify-self-end">
                  <Image src="/svsfood/ss-app1.png" alt="Visual Catalog" fill className="object-cover" />
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
               ...
               <div className="relative aspect-[9/19] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 w-full max-w-[320px] justify-self-center lg:justify-self-end">
                  <Image src="/svsfood/ss-app2.png" alt="Smart Ordering" fill className="object-cover" />
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
               ...
               <div className="relative aspect-[9/19] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 w-full max-w-[320px] justify-self-center lg:justify-self-end">
                  <Image src="/svsfood/ss-app3.png" alt="Checkout Flow" fill className="object-cover" />
               </div>
            </div>
         </div>
      </div>
